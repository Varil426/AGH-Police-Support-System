...
public class SimulationNavigationService : INavigationService
{
    ...
    public Task DisplayRouteTo(Position position, bool isEmergency = false) => _messageBus.SendSimulationMessage(new PatrolDestinationMessage(position, _patrolInfoService.PatrolId, isEmergency));
}