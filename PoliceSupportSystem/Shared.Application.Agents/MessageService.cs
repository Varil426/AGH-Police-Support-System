...
//                     x => x.Id == receiver && x.AcceptedMessageTypes.Contains(message.GetType()));
//                 if (sub is not null)
//                     receivers.Add(sub);
//             }
//         else
//             receivers.AddRange(_subscribers.Where(x => x.AcceptedMessageTypes.Contains(message.GetType())));
//
